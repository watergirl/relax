...
@interface TuWanPicViewController1 ()<MWPhotoBrowserDelegate>
@property(nonatomic,strong) TuWanPicViewModel1 *tuwanPicVM;
@end
@implementation TuWanPicViewController1
- (TuWanPicViewModel1 *)tuwanPicVM{
    if (!_tuwanPicVM) {
        _tuwanPicVM = [[TuWanPicViewModel1 alloc] initWithAid:_aid];
    }
    return _tuwanPicVM;
}
