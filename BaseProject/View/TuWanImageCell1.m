...
@implementation TuWanImageCell1
- (UILabel *)titleLb {
    if(_titleLb == nil) {
...
- (TRImageView1*)iconIV0 {
    if(_iconIV0 == nil) {
        _iconIV0 = [[TRImageView1 alloc] init];
        //_iconIV0.contentMode = 2;
    }
    return _iconIV0;
}

- (TRImageView1 *)iconIV1 {
    if(_iconIV1 == nil) {
        _iconIV1 = [[TRImageView1 alloc] init];
        //_iconIV1.contentMode = 2;
    }
    return _iconIV1;
}

- (TRImageView1 *)iconIV2 {
    if(_iconIV2 == nil) {
        _iconIV2 = [[TRImageView1 alloc] init];
