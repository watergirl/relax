...
+ (void)addMenuItemToVC:(UIViewController *)vc{
    ...
    [btn setBackgroundImage:[UIImage imageNamed:@"Drawer_iOS7"] forState:UIControlStateNormal];
    [btn setBackgroundImage:[UIImage imageNamed:@"Drawer_iOS7"] forState:UIControlStateHighlighted];
